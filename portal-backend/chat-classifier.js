...
const EXTERNAL_RESEARCH = /\b(online|web|website|internet|latest|current|published|publication|paper|literature|citation|source|link|download|official|research says|known about|documentation|version)\b|where (?:can|do) i (?:get|find)|average genome (size|length)|genome (size|length)|could .* explain|mechanism|biological role|associated with/i;
