...
let textNavigation=false, largeText=false, assistReturn=false;
try { textNavigation=storage.getItem('microload.textNavigation')==='true';largeText=storage.getItem('microload.largeText')==='true';assistReturn=storage.getItem('microload.assistReturn')==='true'; } catch {}
